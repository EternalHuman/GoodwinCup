...
const DEFAULT_STATE = {
  ...
  games: [
    { id: "game-1", title: "CS2", color: DEFAULT_COLORS[0], icon: makeDefaultIcon("CS", DEFAULT_COLORS[0]) },
    { id: "game-2", title: "Dota", color: DEFAULT_COLORS[1], icon: makeDefaultIcon("D2", DEFAULT_COLORS[1]) },
    { id: "game-3", title: "Race", color: DEFAULT_COLORS[2], icon: makeDefaultIcon("RC", DEFAULT_COLORS[2]) },
    { id: "game-4", title: "FIFA", color: DEFAULT_COLORS[3], icon: makeDefaultIcon("FC", DEFAULT_COLORS[3]) },
    { id: "game-5", title: "MK", color: DEFAULT_COLORS[4], icon: makeDefaultIcon("MK", DEFAULT_COLORS[4]) }
  ],
  scores: {}
};
